...
async function fetchTags(fetch: typeof globalThis.fetch) {
	try {
...
async function fetchSpotlights(fetch: typeof globalThis.fetch) {
	try {
...
async function fetchCollections(fetch: typeof globalThis.fetch) {
	try {
