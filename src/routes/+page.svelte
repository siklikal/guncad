<script lang="ts">
	...
	import { faChevronRight, faGem, faStar, faFire } from '@fortawesome/free-solid-svg-icons';
	...
	<div class="mx-auto max-w-[1920px] md:px-4">
		<div class="flex flex-col gap-5 xl:flex-row">
			...
			<div class="carousel h-[390px] w-full rounded-lg lg:flex-1">
				<div id="slide1" class="carousel-item relative h-full w-full overflow-hidden rounded-lg">
